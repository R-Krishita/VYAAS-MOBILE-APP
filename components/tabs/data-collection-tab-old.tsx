...
export function DataCollectionTab({ onAuthClick }: DataCollectionTabProps) {
  ...
  const handleAutoDetectLocation = () => {
    // Simulate GPS detection with loading state
  ...
  const handleRecommendCrops = () => {
    // Validate basic data
    if (!formData.farmName || !formData.landSize) {
      toast.error("Please fill in basic farm information")
      return
    }
    
    // Save data first
    localStorage.setItem("farmData", JSON.stringify(formData))
    toast.success("Data saved! Generating recommendations...")
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                placeholder={isDetectingLocation ? "Detecting location..." : "Location will be auto-detected"}
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isDetectingLocation ? "Detecting your GPS coordinates..." : "GPS coordinates for precise location"}
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div>
            <Label className="flex items-center gap-2">
              ...
              Field Images ({uploadedImages.length}/3)
            </Label>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Photos help provide better recommendations
            </p>
          </div>
        </div>
      ),
